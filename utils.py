...
def get_arguments_for_cleaning():
    ...
    parser.add_argument('-n', '--nutch_path', type=str, default='/home/batyr/workspace/crawling/nutch',
    ...
    parser.add_argument('-c', '--csv', type=str, default='/home/batyr/workspace/all_links',
